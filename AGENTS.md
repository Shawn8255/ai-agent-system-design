...
- Chapters 4-6 are now drafted in Markdown and should be edited consistently with the established system-design voice.
- Do not draft Chapter 7 or later yet. Chapter 7 and later may appear only as planned chapters.
...
- `01-*` through `06-*` contain Chapters 1-6.

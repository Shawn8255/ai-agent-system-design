...
- Edit Chapters 4-14 in the same system-design voice as the existing book.
- Do not add new chapters beyond Chapter 14 without first proposing the chapter plan in both languages.
...
- No new Chapter 15 or later drafted prose was introduced.

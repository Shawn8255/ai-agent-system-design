...
- Edit Chapters 4-9 in the same system-design voice as the existing book.
- Do not add Chapter 10 prose yet.
- Keep planned chapters from Chapter 10 onward as plan entries, not drafted chapters.
...
- No new Chapter 10 or later drafted prose was introduced.

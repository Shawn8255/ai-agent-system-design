...
- [x] Draft Chapter 14 (Part II opening): learned memory, skill and routing.
- [x] Add a "harness" terminology section to Chapter 3 (3.8) and reinforce Chapter 13.6 with the harness/model decoupling argument.
- [x] Generate v0.10 DOCX/PDF release artifacts for Chapters 1-14.
